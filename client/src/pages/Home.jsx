...
const Home = () => {
  ...
  return (
    <div className="p-4 bg-orange-100 dark:bg-neutral-800 dark:text-white min-h-screen">
      ...
      <div>
        <h2 className="text-6xl mb-5 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-black to-black text-center mt-6 dark:text-white">All Books</h2>
